...
{{- define "bundle-generator-charts.name" -}}
{{- .Chart.Name | trunc 40 | trimSuffix "-" -}}
{{- end -}}

{{- define "bundle-generator-charts.appSuffix" -}}
{{- $globalAppSuffix := "" -}}
...
{{- define "bundle-generator-charts.fullname" -}}
{{- $appSuffix := include "bundle-generator-charts.appSuffix" . -}}
...
*/}}
{{- define "bundle-generator-charts.chart" -}}
